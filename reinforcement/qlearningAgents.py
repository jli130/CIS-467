...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        "*** YOUR CODE HERE ***"
        update = (1 - self.alpha) * self.getQValue(state, action)
        self.qValues[(state, action)] = update + self.alpha * (reward + self.discount * self.computeValueFromQValues(nextState))
